  ...
  return (
    <nav className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-4 px-32 font-bold text-white">
      <div className="container mx-auto flex justify-between items-center">
        <Link to={"/"}>
          <img src={logo} alt="PaySync Logo" className="w-36" />
        </Link>
        <ul className="hidden md:flex space-x-6">
          <li>
            <Link
              to={"https://www.npmjs.com/package/paysync"}
          ...
          <li>
            <Link to={"/installation"} className="hover:text-gray-300">
              Installation
            </Link>
          </li>
          <li>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <a
            ...
            className="block py-2 px-4 text-sm hover:bg-purple-600"
          >
            Guide
          </a>
          <a
